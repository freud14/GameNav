...
/**
 * The primary key class for the TECHNO_RESSOURCE database table.
 * 
 */
@Embeddable
public class TechnoRessourcePK implements Serializable {

	// default serial version id, required for serializable classes.
	private static final long	serialVersionUID	= 1L;

	@Column(name = "TECHNOLOGIE_ID", insertable = false, updatable = false)
	private int					technologieId;

	@Column(name = "RESSOURCE_ID", insertable = false, updatable = false)
	private int					ressourceId;

	public TechnoRessourcePK() {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TechnoRessourcePK)) {
			return false;
		}
		TechnoRessourcePK castOther = (TechnoRessourcePK) other;
		return (this.technologieId == castOther.technologieId)
